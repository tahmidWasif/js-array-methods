...
function findEmployeeById(id) {
    ...
    if (foundEmployee) {
        ...
        document.getElementById("employeesDetails").innerHTML = `No employee has been found with ID: ${id}`;
    }
}
...
function findEmployeeBySpecialization(specialization) {
    ...
    if (foundEmployee) {
        ...
        document.getElementById("employeesDetails").innerHTML = `<p>No employee has been found with the specialization of ${specialization}</p>`;
    }
}